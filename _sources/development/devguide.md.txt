...
Here we discuss how ISOSIMpy is structured internally and how new functionality (especially to the GUI) can be added easily.
...
Figure 1: The pricipal structure of the ISOSIMpy package and its main parts. Main modules are written in bold; main mechanisms and connections are represented via arrows.
```

## Adding New Functionality

The addition of new functionality is best illustrated looking at the general structure of ISOSIMpy.
